...
OUTPUT_FILE = OUTPUT_DIR / "Central_Kitchen_Access_Control_Comparison_v2.xlsx"
...
def classify_access_item(description: str) -> str:
    ...
    if (
        "access door system controller" in text
        or (
            "controller" in text
            and "door" not in text
        )
    ):
