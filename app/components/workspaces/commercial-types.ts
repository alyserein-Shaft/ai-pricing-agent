...
export type PricingLineView = { itemId: string; itemNumber?: string | null; description: string; status: string; version: number; selectedSource?: { id?: string; type?: string; supplier?: string; currency?: string; amount?: number; validUntil?: string | null; eligibleForCosting?: boolean } | null; result?: { totalCost?: number; netSelling?: number; vat?: number; finalValue?: number; margin?: number; markup?: number; blockers?: string[]; explanation?: string; approvalReady?: boolean } | null };
